...
const DEFAULT_PROMPTS: Record<PromptKey, string> = {
  ...
  "manual-compress": `<dcp-manual-trigger>\nThe user requested /dcp compress{{focus}}.\nInspect the visible DCP message ids internally. Do not show DCP XML tags to the user. If there is closed, old, or low-priority context, call the compress tool now with one or more ranges and high-fidelity summaries.\nIf this exact moment is critical, you may defer briefly, but do not wait beyond the hard context limit.\n</dcp-manual-trigger>`,
};
